...
<body class="bg-light">
    ...
    <!---------------- Section Chambres ------------>
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">Hypnos Hôtel Maldives</h2>
        <hr>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 px-4">
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="row g-0 p-3 align-items-center">
                        <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                            <img src="images/rooms/room-13.jpg" class="img-fluid rounded" alt="...">
                        </div>
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            <h5 class="mb-3">Suite Playa</h5>
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="row g-0 p-3 align-items-center">
                        <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                            <img src="images/rooms/room-14.jpg" class="img-fluid rounded" alt="...">
                        </div>
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            <h5 class="mb-3">Suite Serenity</h5>
                            <div class="features mb-3">
                                <h6 class="mb-1">Détails</h6>
                                <span class="badge rounded-pill bg-light text-dark text-wrap">
                                    2 lits double
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="row g-0 p-3 align-items-center">
                        <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                            <img src="images/rooms/room-15.jpg" class="img-fluid rounded" alt="...">
                        </div>
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            <h5 class="mb-3">Suite Melody</h5>
                            <div class="features mb-3">
                                <h6 class="mb-1">Détails</h6>
                                <span class="badge rounded-pill bg-light text-dark text-wrap">
                                    2 lits double
